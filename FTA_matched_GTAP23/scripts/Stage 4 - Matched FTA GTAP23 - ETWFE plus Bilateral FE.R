...
## >>> EDIT THIS PER CHUNK <<<
chunk_sectors <- c("crp")   # Chunk 4 (final)   (Chunk 1: 10 small; Chunk 2: ome tal; Chunk 3: mff)
...
out_dir      <- file.path(etwfe_dir, "FTA_matched_GTAP23_Outputs", "stage4_etwfe_pairfe")
